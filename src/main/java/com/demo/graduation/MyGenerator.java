...
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\Workspace\\graduation\\src\\main\\java");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/mydb?characterEncoding=utf8&useSSL=true");
        mpg.setDataSource(dsc);

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        //strategy.setTablePrefix(new String[] { "food_role_permission" });// 此处可以修改为您的表前缀
        ...
        // "t_installment_payment",
        // "t_installment_user",
        // "t_installment_user_bank",
        }); // 需要生成的表
        ...
        pc.setParent("com.demo.graduation");
